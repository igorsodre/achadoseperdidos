 ...
 */
class Obj extends \Entity\Obj implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Obj' . "\0" . 'id', '' . "\0" . 'Entity\\Obj' . "\0" . 'identificacao', '' . "\0" . 'Entity\\Obj' . "\0" . 'descricao', '' . "\0" . 'Entity\\Obj' . "\0" . 'data', '' . "\0" . 'Entity\\Obj' . "\0" . 'foto', '' . "\0" . 'Entity\\Obj' . "\0" . 'status', '' . "\0" . 'Entity\\Obj' . "\0" . 'perfil');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Obj $proxy) {
    ...
    public function getIdentificacao()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdentificacao', array());
    ...
    public function setIdentificacao($identificao)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdentificacao', array($identificao));

        return parent::setIdentificacao($identificao);
    }
    ...
    public function arrayToObjeto($arr)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'arrayToObjeto', array($arr));

        return parent::arrayToObjeto($arr);
    }
